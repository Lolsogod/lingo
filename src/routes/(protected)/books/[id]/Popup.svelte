...
{#if isVisible} <!-- Use isVisible to conditionally render the popup -->
  <!-- svelte-ignore a11y-click-events-have-key-events -->
  <!-- svelte-ignore a11y-no-static-element-interactions -->
  <div on:click class="fixed inset-0 z-0"> <!-- Backdrop covering the entire viewport -->
    <!-- Prevent click inside the popup from closing it -->
    <!-- svelte-ignore a11y-click-events-have-key-events -->
    <!-- svelte-ignore a11y-no-static-element-interactions -->
    <div bind:offsetHeight={ref}
